...
<div id="loginbox">
    <form name="form1" class="form-vertical" action="" method="post">
        ...
        <div class="form-actions">
            <center> <input type="submit" name="submit" value="login" class="btn btn-success"></a></center>
    ...
    <?php
            ...
            $count=0;
            $res=mysqli_query($link,"SELECT * FROM `user_registration` WHERE username='$username' AND upassword='$password'AND urole='admin'");
